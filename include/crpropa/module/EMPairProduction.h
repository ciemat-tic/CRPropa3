...
private:
	...
	long double limit;						// limit the step to a fraction of the mean free path
	long double thinning;					// factor of the thinning (0: no thinning, 1: maximum thinning)
...
public:
	 ...
	 */
	EMPairProduction(ref_ptr<PhotonField> photonField, bool haveElectrons = false, long double thinning = 0,long double limit = 0.1);
